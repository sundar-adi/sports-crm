<template>
  <form v-on:submit.prevent="submit" novalidate>
     <div class="uk-flex uk-flex-between uk-flex-wrap uk-flex-wrap-between">
        <div class="uk-width-1-2@m uk-padding-small uk-padding-remove-vertical uk-padding-remove-left">
        ...
        <div class="uk-width-1-2@m uk-padding-small uk-padding-remove-vertical uk-padding-remove-right">
        ...
        <div class="uk-width-1-2@m uk-margin-right uk-padding-small uk-padding-remove-vertical uk-padding-remove-left">
