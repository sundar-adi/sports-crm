<template>
  <form v-on:submit.prevent="submit" novalidate>
     <div class="uk-flex uk-flex-between uk-flex-wrap uk-flex-wrap-between">
        <div class="uk-width-1-2@m uk-padding-small@m uk-padding-remove-vertical uk-padding-remove-left@m">
        ...
        <div class="uk-width-1-2@m uk-padding-small@m uk-padding-remove-vertical uk-padding-remove-right@m">
        ...
        <div class="uk-width-1-2@m uk-margin-right uk-padding-smal@ml uk-padding-remove-vertical uk-padding-remove-left@m">
           <label class="uk-form-label">Address</label>
           <div class="uk-margin-medium-bottom uk-margin-right uk-form-controls"><input v-model="form.address" name="address" placeholder="Street, Number..." type="text" class="uk-input">
     ...
     <input v-if="!loading" type="submit" value="proccess subscription" class="uk-button uk-button-primary uk-width-1-2@m uk-margin-medium-top" :disabled="!ready" :class="{'uk-button-primary--disabled': !ready}">
